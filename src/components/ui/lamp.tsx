...
export function LampDemo() {
    return (
      <LampContainer contentClassName="items-start">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-10 w-full">
          <motion.div
            className="text-left" // Use text-left for alignment
          ...
          {/* You can add your project cards grid here later */}
...
export const LampContainer = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative z-50 flex -translate-y-78 md:-translate-y-74 flex-col items-center px-5 w-full",
          contentClassName
        )}
      >
        {children}
